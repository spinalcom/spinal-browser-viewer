...
exports.PUTVALUE = new Algorithm("PUTVALUE", "This algorithm returns the value set by the user (p1) if the input is true or if the input is empty. Otherwise, it throws an error.", [
    "number"
], "number", [
    {
        name: "p1",
