...
(function(mod) {
    ...
    Completion.prototype = {
        close: function() {
            ...
            this.tick = null;
            if (this.options.updateOnCursorActivity) this.cm.off("cursorActivity", this.activityFunc);
        ...
        pick: function(data, i) {
            ...
            if (this.options.closeOnPick) this.close();
        },
        cursorActivity: function() {
            ...
            if (this.data) identStart = this.data.from;
            var pos = this.cm.getCursor(), line = this.cm.getLine(pos.line);
            if (pos.line != this.startPos.line || line.length - pos.ch != this.startLen - this.startPos.ch || pos.ch < identStart.ch || this.cm.somethingSelected() || !pos.ch || this.options.closeCharacters.test(line.charAt(pos.ch - 1))) this.close();
            else {
                var self = this;
    ...
    function Widget(completion, data) {
        ...
        if (overlapY > 0) {
            ...
            if (winH - box.top < spaceAbove) {
                ...
                below = false;
            } else hints.style.height = winH - box.top - 2 + "px";
        }
        ...
        if (selectedHintRange.from !== 0 || selectedHintRange.to !== 0) this.scrollToActive();
    ...
    function resolveAutoHints(cm, pos) {
        ...
        if (helpers.length) {
            ...
            return resolved;
        } else if (words = cm.getHelper(cm.getCursor(), "hintWords")) return function(cm) {
            return CodeMirror.hint.fromList(cm, {
                words: words
            });
        };
        else if (CodeMirror.hint.anyword) return function(cm, options) {
    ...
    CodeMirror.registerHelper("hint", "fromList", function(cm, options) {
        ...
        if (token.start < cur.ch && /\w/.test(token.string.charAt(cur.ch - token.start - 1))) term = token.string.substr(0, cur.ch - token.start);
        else {
            term = "";
            from = cur;
        }
...
(function(mod) {
    ...
    function scriptHint(editor, keywords, getToken, options) {
        ...
        if (!/^[\w$_]*$/.test(token.string)) token = {
            start: cur.ch,
            end: cur.ch,
            string: "",
            state: token.state,
    ...
    function forAllProps(obj, callback) {
        if (!Object.getOwnPropertyNames || !Object.getPrototypeOf) for(var name in obj)callback(name);
        else for(var o = obj; o; o = Object.getPrototypeOf(o))Object.getOwnPropertyNames(o).forEach(callback);
    }
...
(function(mod) {
    ...
    Annotation.prototype.redraw = function(compute) {
        ...
        if (cm.display.barWidth) for(var i = 0, nextTop; i < anns.length; i++){
            ...
            if (ann.id) elt.setAttribute("annotation-id", ann.id);
        }
...
// Distributed under an MIT license: https://codemirror.net/5/LICENSE
(function(mod) {
    mod(require("bceb284d2d86b414"), require("eb147f6f7c81b05"), require("cbc290763e348e5e"));
})(function(CodeMirror) {
    "use strict";
...
(function(mod) {
    mod(require("73a85e348c45f95e"), require("27da36b020ac34b4"));
})(function(CodeMirror) {
    "use strict";
    var defaults = {
    ...
    def("text/x-ceylon", {
        ...
        hooks: {
            ...
            token: function(_stream, state, style) {
                if ((style == "variable" || style == "type") && state.prevToken == ".") return "variable-2";
            }
        },
        modeProps: {
            fold: [
...
(function(mod) {
    ...
    CodeMirror.defineExtension("toggleComment", function(options) {
        ...
        for(var i = ranges.length - 1; i >= 0; i--){
            ...
            } else if (mode == "un") cm.uncomment(from, to, options);
            else cm.lineComment(from, to, options);
        }
    });
        ...
        self.operation(function() {
            if (options.indent) {
                ...
                for(var i = from.line; i < end; ++i){
                    ...
                    if (baseString == null || baseString.length > whitespace.length) baseString = whitespace;
                }
                for(var i = from.line; i < end; ++i){
                ...
                for(var i = from.line; i < end; ++i)if (blankLines || nonWS.test(self.getLine(i))) self.replaceRange(commentString + pad, Pos(i, 0));
            }
        });
    });
...
// Ctrl-G.
(function(mod) {
    mod(require("eb5c1e860bbbb070"), require("a77427fe6d604cb6"), require("ad7973a66f51a80d"));
})(function(CodeMirror) {
    "use strict";
    ...
    function replace(cm, all) {
        ...
        dialog(cm, fragment, dialogText, query, function(query) {
            ...
            dialog(cm, getReplacementQueryDialog(cm), cm.phrase("Replace with:"), "", function(text) {
                ...
                if (all) replaceAll(cm, query, text);
                else {
                    clearSearch(cm);
...
(function(mod) {
    mod(require("bb0547a2789624cc"), require("9c1520ec994abe36"), require("393b197d660ffdad"));
})(function(CodeMirror) {
    "use strict";
    ...
    cmds.skipAndSelectNextOccurrence = function(cm) {
        ...
        if (CodeMirror.cmpPos(prevAnchor, prevHead) != 0) cm.doc.setSelections(cm.doc.listSelections().filter(function(sel) {
    ...
    cmds.toggleBookmark = function(cm) {
        ...
        for(var i = 0; i < ranges.length; i++){
            ...
            for(var j = 0; j < found.length; j++)if (found[j].sublimeBookmark) {
                found[j].clear();
...
// Distributed under an MIT license: https://codemirror.net/5/LICENSE
(function(mod) {
    mod(require("b5576cb0f364ff11"), require("f7656db25b1274b5"));
})(function(CodeMirror) {
    "use strict";
...
(function(mod) {
    ...
    CodeMirror.registerHelper("fold", "indent", function(cm, start) {
        ...
        for(var i = start.line + 1, end = cm.lastLine(); i <= end; ++i){
            ...
            if (indent == -1) ;
            else if (indent > myIndent) // Lines with a greater indent are considered part of the block.
            lastLineInFold = i;
            else break;
        }
...
//# sourceMappingURL=spinal-env-viewer-plugin-network-tree.bfd82561.js.map
