...
let initialize = ()=>{
    ...
    script._scopeId = "data-v-8e623a";
    require("23718911b98380cf").default(script);
    script.__scopeId = "data-v-8e623a";
