...
})({"74iWe":[function(require,module,exports) {
...
const Analytic_1 = require("40cc7b47784632d0");
Object.defineProperty(exports, "AnalyticModel", {
    enumerable: true,
    get: function() {
        return Analytic_1.AnalyticModel;
    }
});
const AnalyticService_1 = require("229a94fc7be3977b");
...
},{"40cc7b47784632d0":"d4334","229a94fc7be3977b":"dbVqY"}],"d4334":[function(require,module,exports) {
"use strict";
Object.defineProperty(exports, "__esModule", {
    value: true
});
exports.AnalyticModel = void 0;
const spinal_core_connectorjs_type_1 = require("dbe96ba3b1048607");
...
},{"dbe96ba3b1048607":"fRH70"}],"dbVqY":[function(require,module,exports) {
"use strict";
...
const spinal_env_viewer_graph_service_1 = require("3f3844204eedee57");
const spinal_env_viewer_plugin_group_manager_service_1 = require("682dd65e66e02bae");
const Analytic_1 = require("63aaf99b470342ed");
class AnalyticService {
    ...
    getGroupsLinked(analyticId) {
        return spinal_env_viewer_graph_service_1.SpinalGraphService.getChildren(analyticId, [
            this.ANALYTIC_TO_GROUP_RELATION
        ]);
    }
    isLinkedToAnalytic(analyticId, nodeId) {
        return __awaiter(this, void 0, void 0, function*() {
            const children = yield spinal_env_viewer_graph_service_1.SpinalGraphService.getChildren(analyticId, [
                this.ANALYTIC_TO_GROUP_RELATION
            ]);
...
},{"3f3844204eedee57":"9n7zp","682dd65e66e02bae":"tSLpq","63aaf99b470342ed":"d4334"}],"kl5Fe":[function(require,module,exports) {
...
//# sourceMappingURL=spinal-env-viewer-room-manager.ca401d50.js.map
