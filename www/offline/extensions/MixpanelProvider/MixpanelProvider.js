...
/***/ "./extensions/MixpanelProvider/mixpanel.js":
/*!*************************************************!*\
  !*** ./extensions/MixpanelProvider/mixpanel.js ***!
  \*************************************************/
...
/* harmony export */   "Mixpanel": () => (/* binding */ Mixpanel)
/* harmony export */ });
...
var PROVIDER_NAME = 'mixpanel';

/** 
                                 * Wraps the mixpanel api for sending usage data
                                 *
                                 */var
Mixpanel = /*#__PURE__*/function (_Autodesk$Viewing$Pri) {_inherits(Mixpanel, _Autodesk$Viewing$Pri);var _super = _createSuper(Mixpanel);
  function Mixpanel(options) {var _this;_classCallCheck(this, Mixpanel);
    _this = _super.call(this, options);
    _this.initialized = false;return _this;
  }_createClass(Mixpanel, [{ key: "init", value: function init()

    {
      if (!this.options.token) {
        logger.warn('Mixpanel token is not defined');
      }
      mixpanel_browser__WEBPACK_IMPORTED_MODULE_0___default().init(this.options.token, this.options.config);
  ...
  }, { key: "register", value: function register(props) {
      mixpanel_browser__WEBPACK_IMPORTED_MODULE_0___default().register(props);
    ...
    {
      return mixpanel_browser__WEBPACK_IMPORTED_MODULE_0___default().has_opted_out_tracking();
    } }, { key: "optOut", value: function optOut(

    options) {
      // Opt a user out of data collection
      this.track('OptOutTracking');
      mixpanel_browser__WEBPACK_IMPORTED_MODULE_0___default().opt_out_tracking(options);
    } }, { key: "getDistinctId", value: function getDistinctId()

    {
      return mixpanel_browser__WEBPACK_IMPORTED_MODULE_0___default().get_distinct_id();
    } }, { key: "optIn", value: function optIn(

    options) {
      // Opt the user in to data tracking
      mixpanel_browser__WEBPACK_IMPORTED_MODULE_0___default().opt_in_tracking(options);
      this.track('OptInTracking');
    } }, { key: "track", value: function track(

    event, properties) {
      mixpanel_browser__WEBPACK_IMPORTED_MODULE_0___default().track(event, properties);
    }
    ...
    distinctId) {
      mixpanel_browser__WEBPACK_IMPORTED_MODULE_0___default().identify(distinctId);
    } }], [{ key: "name", get: function get() {return PROVIDER_NAME;} }, { key: "defaultOptions", get: function get() {return { token: '7cecb637d6468a8b61f388bbb82072ee', // Viewer Mixpanel account
        config: { persistence: 'localStorage', batch_requests: true, batch_size: 500, batch_flush_interval_ms: 15000, // The autotrack option is needed to prevent a GET request below on mixpanel.init() 
          ...
          autotrack: false } };} }]);return Mixpanel;}(Autodesk.Viewing.Private.AnalyticsProviderInterface);
...
"use strict";
/*!**********************************************!*\
  !*** ./extensions/MixpanelProvider/index.js ***!
  \**********************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _mixpanel__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./mixpanel */ "./extensions/MixpanelProvider/mixpanel.js");
function _typeof(obj) {"@babel/helpers - typeof";if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") {_typeof = function _typeof(obj) {return typeof obj;};} else {_typeof = function _typeof(obj) {return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj;};}return _typeof(obj);}function _classCallCheck(instance, Constructor) {if (!(instance instanceof Constructor)) {throw new TypeError("Cannot call a class as a function");}}function _defineProperties(target, props) {for (var i = 0; i < props.length; i++) {var descriptor = props[i];descriptor.enumerable = descriptor.enumerable || false;descriptor.configurable = true;if ("value" in descriptor) descriptor.writable = true;Object.defineProperty(target, descriptor.key, descriptor);}}function _createClass(Constructor, protoProps, staticProps) {if (protoProps) _defineProperties(Constructor.prototype, protoProps);if (staticProps) _defineProperties(Constructor, staticProps);return Constructor;}function _inherits(subClass, superClass) {if (typeof superClass !== "function" && superClass !== null) {throw new TypeError("Super expression must either be null or a function");}subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, writable: true, configurable: true } });if (superClass) _setPrototypeOf(subClass, superClass);}function _setPrototypeOf(o, p) {_setPrototypeOf = Object.setPrototypeOf || function _setPrototypeOf(o, p) {o.__proto__ = p;return o;};return _setPrototypeOf(o, p);}function _createSuper(Derived) {var hasNativeReflectConstruct = _isNativeReflectConstruct();return function _createSuperInternal() {var Super = _getPrototypeOf(Derived),result;if (hasNativeReflectConstruct) {var NewTarget = _getPrototypeOf(this).constructor;result = Reflect.construct(Super, arguments, NewTarget);} else {result = Super.apply(this, arguments);}return _possibleConstructorReturn(this, result);};}function _possibleConstructorReturn(self, call) {if (call && (_typeof(call) === "object" || typeof call === "function")) {return call;}return _assertThisInitialized(self);}function _assertThisInitialized(self) {if (self === void 0) {throw new ReferenceError("this hasn't been initialised - super() hasn't been called");}return self;}function _isNativeReflectConstruct() {if (typeof Reflect === "undefined" || !Reflect.construct) return false;if (Reflect.construct.sham) return false;if (typeof Proxy === "function") return true;try {Date.prototype.toString.call(Reflect.construct(Date, [], function () {}));return true;} catch (e) {return false;}}function _getPrototypeOf(o) {_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf : function _getPrototypeOf(o) {return o.__proto__ || Object.getPrototypeOf(o);};return _getPrototypeOf(o);}

var av = Autodesk.Viewing;
var avp = av.Private;var

MixpanelExtension = /*#__PURE__*/function (_Autodesk$Viewing$Ext) {_inherits(MixpanelExtension, _Autodesk$Viewing$Ext);var _super = _createSuper(MixpanelExtension);

  function MixpanelExtension(viewer, options) {_classCallCheck(this, MixpanelExtension);return _super.call(this,
    viewer, options);
  }_createClass(MixpanelExtension, [{ key: "load", value: function load()
    ...
    {return false;} }]);return MixpanelExtension;}(Autodesk.Viewing.Extension);


av.theExtensionManager.registerExtension('Autodesk.Viewing.MixpanelExtension', MixpanelExtension);
avp.analytics.registerProvider(_mixpanel__WEBPACK_IMPORTED_MODULE_0__.Mixpanel);
})();

Autodesk.Extensions.MixpanelProvider = __webpack_exports__;
/******/ })()
;
//# sourceMappingURL=MixpanelProvider.js.map