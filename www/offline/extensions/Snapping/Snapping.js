  ...
  this.snapMidpoint = function () {
    ...
    if (_isSnapped) {
      if (_snapResult.geomType === SnapType.SNAP_EDGE) {
        ...
        if (cutPlanes === null || cutPlanes === void 0 ? void 0 : cutPlanes.length) {
...
/* harmony export */ });
function _typeof(obj) {"@babel/helpers - typeof";if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") {_typeof = function _typeof(obj) {return typeof obj;};} else {_typeof = function _typeof(obj) {return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj;};}return _typeof(obj);}function _inherits(subClass, superClass) {if (typeof superClass !== "function" && superClass !== null) {throw new TypeError("Super expression must either be null or a function");}subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, writable: true, configurable: true } });if (superClass) _setPrototypeOf(subClass, superClass);}function _setPrototypeOf(o, p) {_setPrototypeOf = Object.setPrototypeOf || function _setPrototypeOf(o, p) {o.__proto__ = p;return o;};return _setPrototypeOf(o, p);}function _createSuper(Derived) {var hasNativeReflectConstruct = _isNativeReflectConstruct();return function _createSuperInternal() {var Super = _getPrototypeOf(Derived),result;if (hasNativeReflectConstruct) {var NewTarget = _getPrototypeOf(this).constructor;result = Reflect.construct(Super, arguments, NewTarget);} else {result = Super.apply(this, arguments);}return _possibleConstructorReturn(this, result);};}function _possibleConstructorReturn(self, call) {if (call && (_typeof(call) === "object" || typeof call === "function")) {return call;}return _assertThisInitialized(self);}function _assertThisInitialized(self) {if (self === void 0) {throw new ReferenceError("this hasn't been initialised - super() hasn't been called");}return self;}function _isNativeReflectConstruct() {if (typeof Reflect === "undefined" || !Reflect.construct) return false;if (Reflect.construct.sham) return false;if (typeof Proxy === "function") return true;try {Date.prototype.toString.call(Reflect.construct(Date, [], function () {}));return true;} catch (e) {return false;}}function _getPrototypeOf(o) {_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf : function _getPrototypeOf(o) {return o.__proto__ || Object.getPrototypeOf(o);};return _getPrototypeOf(o);}function _classCallCheck(instance, Constructor) {if (!(instance instanceof Constructor)) {throw new TypeError("Cannot call a class as a function");}}function _defineProperties(target, props) {for (var i = 0; i < props.length; i++) {var descriptor = props[i];descriptor.enumerable = descriptor.enumerable || false;descriptor.configurable = true;if ("value" in descriptor) descriptor.writable = true;Object.defineProperty(target, descriptor.key, descriptor);}}function _createClass(Constructor, protoProps, staticProps) {if (protoProps) _defineProperties(Constructor.prototype, protoProps);if (staticProps) _defineProperties(Constructor, staticProps);return Constructor;}var MeasureCommon = Autodesk.Viewing.MeasureCommon;
...
var NullSnapperIndicator = /*#__PURE__*/function () {function NullSnapperIndicator() {_classCallCheck(this, NullSnapperIndicator);}_createClass(NullSnapperIndicator, [{ key: "isNull", value: function isNull()
    {
      return true;
    } }, { key: "render", value: function render()

    {} }, { key: "removeOverlay", value: function removeOverlay(
    overlayName) {} }, { key: "clearOverlay", value: function clearOverlay(
    overlayName) {} }, { key: "clearOverlays", value: function clearOverlays()
    {} }, { key: "addOverlay", value: function addOverlay(
    overlayName, mesh) {} }, { key: "drawFace", value: function drawFace(
    geom, material, overlayName) {} }, { key: "cylinderMesh", value: function cylinderMesh(
    pointX, pointY, material, width) {
      return new THREE.Mesh();
    } }, { key: "renderGeometry", value: function renderGeometry(
    snapResult) {} }, { key: "renderVertexIndicator", value: function renderVertexIndicator(
    snapResult) {} }, { key: "renderMidpointIndicator", value: function renderMidpointIndicator(
    snapResult) {} }, { key: "renderEdgeIndicator", value: function renderEdgeIndicator(
    snapResult) {} }, { key: "renderCircleIndicator", value: function renderCircleIndicator(
    snapResult) {} }, { key: "renderPerpendicular", value: function renderPerpendicular(
    snapResult) {} }, { key: "renderPixelIndicator", value: function renderPixelIndicator(
    snapResult) {} }, { key: "renderIndicator", value: function renderIndicator(
    snapResult) {} }, { key: "drawLine", value: function drawLine(
    geom, material, width, overlayName) {} }, { key: "drawPoint", value: function drawPoint(
    point, material, overlayName) {} }, { key: "drawCircle", value: function drawCircle(
    point, material, overlayName) {} }, { key: "setScale", value: function setScale(
    point) {
      return 1;
    } }, { key: "setPointScale", value: function setPointScale(
    pointMesh) {} }, { key: "setCircleScale", value: function setCircleScale(
    torusMesh) {} }, { key: "setEdgeScale", value: function setEdgeScale(
    cylinderMesh) {} }, { key: "updatePointScale", value: function updatePointScale(
    overlayName) {} }, { key: "updateEdgeScale", value: function updateEdgeScale(
    overlayName) {} }, { key: "onCameraChange", value: function onCameraChange()
    {} }, { key: "destroy", value: function destroy()
    {} }]);return NullSnapperIndicator;}();
...
var SnapperIndicator = /*#__PURE__*/function (_NullSnapperIndicator) {_inherits(SnapperIndicator, _NullSnapperIndicator);var _super = _createSuper(SnapperIndicator);
  function SnapperIndicator(viewer, snapper) {var _this;_classCallCheck(this, SnapperIndicator);
  ...
  }_createClass(SnapperIndicator, [{ key: "isNull", value: function isNull()
    ...
    } }, { key: "clearOverlay", value: function clearOverlay(
    ...
    } }, { key: "clearOverlays", value: function clearOverlays()
    ...
    /**
       ...
       */ }, { key: "drawFace", value: function drawFace(
    geom, material, overlayName) {
    ...
    } }, { key: "cylinderMesh", value: function cylinderMesh(
    ...
    /**
       ...
       */ }, { key: "renderVertexIndicator", value: function renderVertexIndicator(
    snapResult) {
    ...
    /**
       ...
       * on a midpoint
       * @param {Autodesk.Viewing.MeasureCommon.SnapResult} snapResult
       */ }, { key: "renderMidpointIndicator", value: function renderMidpointIndicator(
    snapResult) {
    ...
    /**
       ...
       * @param {Autodesk.Viewing.MeasureCommon.SnapResult} snapResult
       */ }, { key: "renderEdgeIndicator", value: function renderEdgeIndicator(
    snapResult) {
    ...
    /**
       ...
       * @param {Autodesk.Viewing.MeasureCommon.SnapResult} snapResult
       */ }, { key: "renderCircleIndicator", value: function renderCircleIndicator(
    snapResult) {
    ...
    /**
       ...
       * @param {Autodesk.Viewing.MeasureCommon.SnapResult} snapResult
       */ }, { key: "renderPerpendicular", value: function renderPerpendicular(
    snapResult) {
    ...
    /**
       ...
       * @param {Autodesk.Viewing.MeasureCommon.SnapResult} snapResult
       */ }, { key: "renderPixelIndicator", value: function renderPixelIndicator(
    snapResult) {
    ...
    } }, { key: "renderIndicator", value: function renderIndicator(
    ...
    } }, { key: "drawLine", value: function drawLine(

    geom, material, width, overlayName) {
    ...
    } }, { key: "drawPoint", value: function drawPoint(

    point, material, overlayName) {
    ...
    } }, { key: "drawCircle", value: function drawCircle(
    ...
    } }, { key: "setScale", value: function setScale(
    ...
    } }, { key: "setCircleScale", value: function setCircleScale(
    ...
    } }, { key: "setEdgeScale", value: function setEdgeScale(
    ...
    } }, { key: "updatePointScale", value: function updatePointScale(
    ...
    } }, { key: "updateEdgeScale", value: function updateEdgeScale(
