...
var ForgeViewer = function () {
  ...
  _createClass(ForgeViewer, [{
    ...
    value: function transformModel(item) {
      ...
      if (force === true || this.updateItem(item) === true) return (0, _transformModel3.default)(this.viewer, item.model, model);
