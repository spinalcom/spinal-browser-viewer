...
let initialize = ()=>{
    ...
    script._scopeId = "data-v-cbc010";
    require("a04b81f91a386088").default(script);
    script.__scopeId = "data-v-cbc010";
...
let initialize = ()=>{
    ...
    script._scopeId = "data-v-68f7fc";
    require("2ff6b6e4780659e1").default(script);
    script.__scopeId = "data-v-68f7fc";
