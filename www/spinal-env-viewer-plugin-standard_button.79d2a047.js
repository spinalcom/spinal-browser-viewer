...
let initialize = ()=>{
    ...
    script._scopeId = "data-v-b7306b";
    require("34246a61773a2dd").default(script);
    script.__scopeId = "data-v-b7306b";
...
let initialize = ()=>{
    ...
    script._scopeId = "data-v-f1f438";
    require("430b9d4c9288cc6f").default(script);
    script.__scopeId = "data-v-f1f438";
