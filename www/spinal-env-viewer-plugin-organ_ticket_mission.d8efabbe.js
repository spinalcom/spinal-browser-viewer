...
let initialize = ()=>{
    ...
    script._scopeId = "data-v-16545c";
    require("d9d674d478874ccd").default(script);
    script.__scopeId = 'data-v-16545c';
