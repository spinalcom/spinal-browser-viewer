...
let initialize = ()=>{
    ...
    script._scopeId = "data-v-c57f9b";
    require("579627595bda4e13").default(script);
    script.__scopeId = 'data-v-c57f9b';
...
let initialize = ()=>{
    ...
    script._scopeId = "data-v-bebbe1";
    require("91f29432b5e9cf4e").default(script);
    script.__scopeId = 'data-v-bebbe1';
...
let initialize = ()=>{
    ...
    script._scopeId = "data-v-15f5a0";
    require("f51ae73faf45e10c").default(script);
    script.__scopeId = 'data-v-15f5a0';
