...
const spinal_env_viewer_graph_service_1 = require("312bbe2d56efe6d");
const SpinalTimeSeries_1 = require("64e6e3260a6998ef");
Object.defineProperty(exports, "SpinalTimeSeries", {
    enumerable: true,
    get: function() {
        return SpinalTimeSeries_1.SpinalTimeSeries;
    }
});
Object.defineProperty(exports, "SpinalTimeSeriesArchive", {
    enumerable: true,
    get: function() {
        return SpinalTimeSeries_1.SpinalTimeSeriesArchive;
    }
});
Object.defineProperty(exports, "SpinalTimeSeriesArchiveDay", {
    enumerable: true,
    get: function() {
        return SpinalTimeSeries_1.SpinalTimeSeriesArchiveDay;
    }
});
const spinal_env_viewer_plugin_documentation_service_1 = require("3603498711e1c2e1");
const spinal_models_documentation_1 = require("e32cb5ed93eff382");
Object.defineProperty(exports, "SpinalAttribute", {
    enumerable: true,
    get: function() {
        return spinal_models_documentation_1.SpinalAttribute;
    }
});
/**
...
},{"312bbe2d56efe6d":"9n7zp","64e6e3260a6998ef":"6IJ8H","3603498711e1c2e1":"5rYVR","e32cb5ed93eff382":"dcbQz"}],"6IJ8H":[function(require,module,exports) {
"use strict";
var __awaiter = this && this.__awaiter || function(thisArg, _arguments, P, generator) {
    function adopt(value) {
        return value instanceof P ? value : new P(function(resolve) {
 ...
 * with this file. If not, see
 * <http://resources.spinalcom.com/licenses.pdf>.
 */ const spinal_core_connectorjs_type_1 = require("3b829b306e3ea040");
...
Object.defineProperty(exports, "SpinalTimeSeriesArchive", {
    enumerable: true,
    get: function() {
        return SpinalTimeSeriesArchive_1.SpinalTimeSeriesArchive;
    }
});
const SpinalTimeSeriesArchiveDay_1 = require("2227dfe7902b02bc");
Object.defineProperty(exports, "SpinalTimeSeriesArchiveDay", {
    enumerable: true,
    get: function() {
        return SpinalTimeSeriesArchiveDay_1.SpinalTimeSeriesArchiveDay;
    }
});
/**
 ...
 */ class SpinalTimeSeries extends spinal_core_connectorjs_type_1.Model {
     ...
     */ constructor(initialBlockSize = 50, maxDay = 2){
        ...
        if (spinal_core_connectorjs_type_1.FileSystem._sig_server === false) return;
...
},{"3b829b306e3ea040":"fRH70","a83e1f4399b9d47e":"3SzvR","27d7ae6bfd6cffd5":"lKzee","23f4c68c927e5956":"9jtWX","2227dfe7902b02bc":"1AJXV"}],"3SzvR":[function(require,module,exports) {
"use strict";
/*
 * Copyright 2018 SpinalCom - www.spinalcom.com
 *
 ...
 * with this file. If not, see
 * <http://resources.spinalcom.com/licenses.pdf>.
 */ const spinal_core_connectorjs_type_1 = require("fae6a81058672efb");
...
},{"fae6a81058672efb":"fRH70"}],"9jtWX":[function(require,module,exports) {
"use strict";
var __awaiter = this && this.__awaiter || function(thisArg, _arguments, P, generator) {
    function adopt(value) {
        return value instanceof P ? value : new P(function(resolve) {
 ...
 * with this file. If not, see
 * <http://resources.spinalcom.com/licenses.pdf>.
 */ const spinal_core_connectorjs_type_1 = require("f5195ab13b29ab30");
 ...
 */ class SpinalTimeSeriesArchive extends spinal_core_connectorjs_type_1.Model {
     ...
     */ getOrCreateArchiveAtDate(atDate) {
        ...
        this.lstItem.insert(index, [
            new spinal_core_connectorjs_type_1.Ptr(value)
        ]);
        const prom = Promise.resolve(value);
        this.itemLoadedDictionary.set(date, prom);
        return prom;
     ...
     */ getFromIntervalTimeGen(start = 0, end = Date.now()) {
        return __asyncGenerator(this, arguments, function* getFromIntervalTimeGen_1() {
            ...
            const normalizedEnd = typeof end === "number" || typeof end === "string" ? new Date(end).getTime() : end;
            for(let idx = 0; idx < this.lstDate.length; idx += 1){
...
},{"f5195ab13b29ab30":"fRH70","1ea1269ce3de9c93":"lKzee","e65cd4aed08f905e":"1AJXV"}],"1AJXV":[function(require,module,exports) {
"use strict";
/*
 * Copyright 2018 SpinalCom - www.spinalcom.com
 *
...
const spinal_core_connectorjs_type_1 = require("708d75b9c497e76f");
/**
 ...
 */ class SpinalTimeSeriesArchiveDay extends spinal_core_connectorjs_type_1.Model {
     ...
     */ get(index) {
        ...
        if (this.lstDate instanceof spinal_core_connectorjs_type_1.TypedArray) return {
...
},{"708d75b9c497e76f":"fRH70"}],"5rYVR":[function(require,module,exports) {
"use strict";
/*
...
//# sourceMappingURL=spinal-env-viewer-plugin-dashboard-standard.0e08e783.js.map
